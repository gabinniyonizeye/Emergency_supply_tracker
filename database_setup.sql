-- Emergency Supply Tracker Database Setup
-- Run this script in PostgreSQL to create the required database and tables

-- Create database (run this first)
CREATE DATABASE emergency_supply_tracker_db;

-- Connect to the database and run the following:
\c emergency_supply_tracker_db;
...
-- Create inventory table (view of donations with status)
...
-- Create function to automatically update inventory when donations change
